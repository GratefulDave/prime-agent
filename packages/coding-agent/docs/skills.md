...
- `context-mode`, `codemap`, `codebase-memory` - optional local intel MCP guides. They stay hidden until `prime-agent mcp enable <name>` and the matching binary is installed.
