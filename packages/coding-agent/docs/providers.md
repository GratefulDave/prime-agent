...
- Device-code login via `auth.x.ai`; inference uses the OpenAI-compatible endpoint `https://api.x.ai/v1`
- Optional env var: `XAI_OAUTH_TOKEN` (`auth.json` key: `xai-oauth`)
